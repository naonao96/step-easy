    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f5f5dc] to-[#deb887]">
      <div className="px-6 py-8 pb-20">
        ...
        <div className="space-y-6">
          ...
          {/* 無料プラン */}
          <div className="bg-gradient-to-br from-[#f5f5dc] to-[#deb887] rounded-2xl p-6 shadow-xl border-2 border-[#8b4513] relative">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-[#8b4513] text-white px-3 py-1 rounded-full text-xs font-bold">
              人気No.1
            </div>
            <div className="text-center">
          ...
          {/* プレミアムプラン */}
          <div className="bg-gradient-to-br from-[#deb887] to-[#f5f5dc] rounded-2xl p-6 shadow-xl border-2 border-[#7c5a2a]">
            <div className="text-center">
