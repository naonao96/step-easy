...
export const PaceStep: React.FC<PaceStepProps> = ({ onNext, onSkip }) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto text-center relative">
      ...
      {/* メインテキスト */}
      <div className="mb-4">
        <h2 className="text-lg lg:text-2xl font-bold leading-tight mb-3 relative">
          {/* メインテキスト */}
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-[#f5f5dc]/60 to-[#deb887]/30 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-[#deb887]/20 mb-6">
          {/* 装飾要素 */}
          <div className="absolute top-3 right-3 w-5 h-5 text-[#8b4513] opacity-40">
          ...
          <div className="relative z-10 text-center">
            <div className="mb-4">
              <p className="text-[#7c5a2a] text-base sm:text-lg leading-relaxed font-medium">
                続けられなかった日があっても、
                <span className="text-[#8b4513] font-bold text-lg">大丈夫。</span>
              </p>
            </div>
            
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl px-4 py-3 border border-[#deb887]/30 shadow-sm">
      ...
      <button
        onClick={onNext}
        className={`group relative w-full font-semibold py-3 px-8 rounded-2xl text-base transition-all duration-500 transform shadow-lg overflow-hidden bg-gradient-to-r from-[#8b4513] to-[#7c5a2a] text-white hover:scale-[1.02] active:scale-[0.98] hover:shadow-2xl`}
      >
        {/* グラデーションオーバーレイ */}
